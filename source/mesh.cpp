...
Mesh* createCubeMesh()
{
    ...
    mesh->vertices =
    {
        ...
        {f({1, 1, 0}), { 1,  0,  0}, {0.00f, 0.5f}},
        {f({1, 1, 1}), { 1,  0,  0}, {0.00f, 0.0f}},
        {f({1, 0, 1}), { 1,  0,  0}, {0.33f, 0.0f}},
        {f({1, 1, 0}), { 0,  1,  0}, {0.66f, 0.5f}},
        {f({0, 1, 0}), { 0,  1,  0}, {0.33f, 0.5f}},
        {f({0, 1, 1}), { 0,  1,  0}, {0.33f, 0.0f}},
        {f({1, 1, 1}), { 0,  1,  0}, {0.66f, 0.0f}},
        {f({0, 1, 0}), {-1,  0,  0}, {0.33f, 1.0f}},
        {f({0, 0, 0}), {-1,  0,  0}, {0.00f, 1.0f}},
        {f({0, 0, 1}), {-1,  0,  0}, {0.00f, 0.5f}},
        ...
        {f({0, 1, 0}), { 0,  0, -1}, {1.00f, 1.0f}},
        {f({1, 1, 0}), { 0,  0, -1}, {1.00f, 0.5f}},
        {f({1, 0, 0}), { 0,  0, -1}, {0.66f, 0.5f}},
        {f({1, 0, 1}), { 0,  0,  1}, {0.66f, 0.5f}},
        {f({1, 1, 1}), { 0,  0,  1}, {1.00f, 0.5f}},
        {f({0, 1, 1}), { 0,  0,  1}, {1.00f, 0.0f}},
